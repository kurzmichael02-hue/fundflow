...
// Twitter card image. Same renderer as opengraph-image; Next.js 16's file
// conventions require the runtime/size constants to be declared inline
// rather than re-exported, so we duplicate the layout here.
