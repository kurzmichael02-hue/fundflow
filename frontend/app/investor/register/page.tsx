        ...
        <div className="w-full max-w-sm">
          ...
          {success ? (
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-2" style={{ letterSpacing: "-0.02em" }}>Check your email</h2>
            ...
            <>
              <div className="mb-8">
                ...
                <h2 className="text-2xl font-bold text-white" style={{ letterSpacing: "-0.02em" }}>Create your account</h2>
